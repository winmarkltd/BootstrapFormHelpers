/* ==========================================================
 * bootstrap-formhelpers-timezones.zh_CN.js
...
var BFHTimezonesList = {
  ...
  'AD': {
    'Europe/Andorra': '安道尔共和国'
  },
  'AO': {
    'Africa/Luanda': '罗安达'
  },
  'AI': {
    'America/Anguilla': '安圭拉岛'
  },
  'AQ': {
    'Antarctica/Casey': '凯西站',
    'Antarctica/Davis': '戴维斯站',
    'Antarctica/DumontDUrville': '迪蒙迪威尔站',
    'Antarctica/Macquarie': '麦考瑞站',
    'Antarctica/Mawson': '莫森站',
    'Antarctica/McMurdo': '麦克默多站',
    'Antarctica/Palmer': '帕默站',
    'Antarctica/Rothera': '罗瑟拉站',
    'Antarctica/South_Pole': '南极',
    'Antarctica/Syowa': '斯韦站',
    'Antarctica/Vostok': '东方号站'
  },
  'AG': {
    'America/Antigua': '安提瓜岛'
  },
  'AR': {
  ...
  'CA': {
    ...
    'America/Blanc-Sablon': '布朗萨布隆',
    'America/Cambridge_Bay': '剑桥湾镇',
    'America/Creston': '可累斯顿',
    'America/Dawson': '道森',
    'America/Dawson_Creek': '道森克里克',
    'America/Edmonton': '埃德蒙顿',
    'America/Glace_Bay': '格莱斯贝',
    'America/Goose_Bay': '古斯贝',
  ...
  'GL': {
    'America/Danmarkshavn': '特克斯和凯科斯群岛',
  ...
  'US': {
    ...
    'America/Denver': '丹佛',
    'America/Detroit': '底特律',
    'America/Indiana/Indianapolis': 'Indiana / 印第安纳波利斯',
    'America/Indiana/Knox': 'Indiana / 诺克斯',
    'America/Indiana/Marengo': 'Indiana / 马伦哥',
    'America/Indiana/Petersburg': 'Indiana / 彼得斯堡',
    'America/Indiana/Tell_City': 'Indiana / 印第安纳州特尔城',
    'America/Indiana/Vevay': 'Indiana / 韦韦',
    'America/Indiana/Vincennes': 'Indiana / 温森斯',
    'America/Indiana/Winamac': 'Indiana / 威纳马克',
    'America/Juneau': '朱诺',
    'America/Kentucky/Louisville': 'Kentucky / 路易斯维尔',
    'America/Kentucky/Monticello': 'Kentucky / 蒙蒂塞洛',
    'America/Los_Angeles': '洛杉矶',
    'America/Menominee': '美浓米尼',
    'America/Metlakatla': '梅特拉卡特拉',
    'America/New_York': '纽约',
    'America/Nome': '诺姆',
    'America/North_Dakota/Beulah': '北达科他州 / 以色列',
    'America/North_Dakota/Center': '北达科他州 / 中心',
    'America/North_Dakota/New_Salem': '北达科他州 / 纽沙龙',
    'America/Phoenix': '凤凰城',
    'America/Shiprock': '希普罗克',
    'America/Sitka': 'Sitka',
